...
<?php include ('asset/inc/nav.inc.php');?>
  ...
  <main id="homePage">
    ...
    <div class="bannerHome">
      <div class="container">
        <div class="col-8">
          ...
          <a href="#" class="btn">Informations</a>
        </div>
      </div>
      <span id="scrollDown"><a href="#uneHomePage"></a></span>
    </div>
    ...
    <section id="uneHomePage" class="container">
      ...
      <div>
        ...
        <article class="col-6">
          <figure>
            <a href="">
              <img src="asset/img/article/article3-S.png" alt="">
            </a>
          </figure>
          <div>
            <h3>Art thérapie</h3>
    ...
    <section id="actuHomePage" class="container">
      ...
      <a href="" class="btn">toutes l'actualité</a>
    ...
    <section class="sectionBlock container">
      ...
      <div class="row">
        <div class="col-6"><a href="" class="block contactBlock">
            <h2>nous contacter</h2>
          </a></div>
        <div class="col-6"><a href="" class="block engageBlock">
            <h2>s'engager</h2>
          </a></div>
